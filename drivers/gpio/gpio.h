...
#define GPIO_LCD_DATA_PORT GPIOD
...
#define GPIO_LCD_CTRL_PORT GPIOA
#define GPIO_LCD_RS_PIN GPIO_Pin_2
#define GPIO_LCD_E_PIN GPIO_Pin_1

#define GPIO_ENC_PORT GPIOD
#define GPIO_ENC_PORT_SOURCE GPIO_PortSourceGPIOD
#define GPIO_ENC_BUTTON_PIN GPIO_Pin_0
#define GPIO_ENC_BUTTON_PIN_SOURCE GPIO_PinSource0
